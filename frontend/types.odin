...
// Note(Dragos): These should be inside checker package
...
is_calling_convention_none :: proc(c: Proc_Calling_Convention) -> bool {
	unimplemented()
}

is_calling_convention_odin :: proc(c: Proc_Calling_Convention) -> bool {
	unimplemented()
}
...
alloc_type_proc :: proc(scope: ^Scope, params: ^Type, param_count: int, results: ^Type, result_count: int, variadic: bool, calling_conv: Proc_Calling_Convention) -> ^Type {
	unimplemented()
}
...
alloc_type_proc_from_types :: proc(param_types: []^Type, results: []^Type, is_c_vararg: bool, calling_conv: Proc_Calling_Convention) -> ^Type {
	//Do later
	unimplemented()
}
