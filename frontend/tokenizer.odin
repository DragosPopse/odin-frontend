...
tokenizer_init :: proc(t: ^Tokenizer, src: string, path: string, err: Tokenizer_Error_Handler = default_error_handler) {
    t.src = src
    t.err = err
    t.ch = ' '
    t.offset = 0
...
tokenizer_init_from_fullpath :: proc(t: ^Tokenizer, src: string, path: string, err: Tokenizer_Error_Handler = default_error_handler) -> Tokenizer_Init_Error {
    t.err = err
    t.ch = ' '
    t.offset = 0
    t.read_offset = 0
